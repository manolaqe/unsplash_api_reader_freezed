...
class _$GetCurrentUserSuccessfulImpl implements GetCurrentUserSuccessful {
  const _$GetCurrentUserSuccessfulImpl(this.appUser);
  ...
  @override
  String toString() {
    return 'GetCurrentUser.successful(appUser: $appUser)';
  }
...
abstract class GetCurrentUserSuccessful implements GetCurrentUser {
  const factory GetCurrentUserSuccessful(final AppUser? appUser) = _$GetCurrentUserSuccessfulImpl;
